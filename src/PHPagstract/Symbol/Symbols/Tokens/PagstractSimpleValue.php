...
*/
        ...
        // apply text abbrivation
        
            // pma:maxlength="10"
            // pma:abbrevMode="strict/after/before" 
            //   strict: hard cut after "10" characters
            //   after: cut word after "10" characters
            //   before: cut word before "10" characters
            // pma:more="..." appendix to abbrivated text
        
        // apply escaping
        
            // convert special characters to HTML entities
            // pma:type="escaped" / previously "raw" or pma:raw="true"
            // ... plus add slashes to " and '
            // pma:type="escapedquotes / previously pma:escapeQuotes="true" 

            // strip tags and convert entities to characters
            // pma:type="plain"
            // ..., but convert HTML entities to UniCode/numeric entities, ex: &uml; -> &#168;
            // pma:type="plainhtml"
    ...
    /**
     * get replacement list for HTML entities to numeric entities
     * in conjunction with {strtr} function
     * ex: $translated = strtr( $string, getHTML401NamedToNumeric() );
     * 
     * @see http://stackoverflow.com/a/11179875
     * 
     * @return string[]
     */
